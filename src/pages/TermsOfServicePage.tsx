        ...
        <Card className="glassmorphism">
          ...
          <CardContent className="space-y-6 text-muted-foreground">
            ...
            <div className="space-y-2">
              ...
              <p>
                By using our application, SixyWin (the "Service"), you agree to
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                Service in any way that could damage the Service, the services,
                or the general business of SixyWin.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                SixyWin and its licensors. The Service is protected by
            ...
            <div className="space-y-2">
              ...
              <p>
                In no event shall SixyWin, nor its directors, employees,
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                application. The virtual coins used in the app have no
                real-world value and cannot be redeemed for cash, prizes, or any
                other items of monetary value. We may provide coupons or other
                rewards as part of our entertainment service, which are subject
