          ...
          <CardContent className="space-y-6 text-muted-foreground">
            <div className="space-y-2">
              ...
              <p>
                ...
                safeguard your information when you use our application. By
                using SixyWin, you agree to the collection and use of
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 pl-4">
                ...
                <li>
                  <strong>Usage Data:</strong> Information that your browser
                  sends whenever you visit our Service or when you access the
                  Service by or through a mobile device. This may include your
                  IP address, browser type, and version.
                </li>
                <li>
                  <strong>Game Data:</strong> We collect data related to your
                  game activity, such as tickets played, numbers chosen, coins
                  won, and leaderboard status.
                </li>
              </ul>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                such as with other players on the leaderboard or on your public
                profile page.
              </p>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                we have on you. You can update your account information at any
                time by logging into your account and visiting your profile
                page.
              </p>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                the app have no real-world value and cannot be exchanged for
                cash or any other items of monetary value. We provide coupons
                and other rewards as part of our entertainment service. All
                activities within the app are for entertainment purposes only.
              </p>
            </div>
          </CardContent>
        </Card>
