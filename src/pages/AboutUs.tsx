        ...
        <Card className="glassmorphism">
          ...
          <CardContent className="space-y-6 text-muted-foreground">
            ...
            <div className="space-y-2">
              ...
              <p>
                Our platform is simple. Users can log in daily to pick their
                lucky numbers, place a bid, and submit a ticket. We then hold a
                draw with winning numbers, and users win virtual coins based on
                how many numbers they match and the size of their bid. It's all
                about the fun of participation and the excitement of the win!
              </p>
            </div>
            <div className="space-y-2">
              <h2 className="text-xl font-semibold text-foreground flex items-center gap-2">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                page. To keep things fresh and speedy, we only display your last
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                application. The virtual coins you win have no real-world
                monetary value and cannot be exchanged for cash. They are purely
                for entertainment and tracking your success on the leaderboard.
                As a thank you for playing, you can convert your winnings into
                valuable coupons from top brands like Amazon, Apple, and more.
                These are our way of adding a little extra perk to your lucky
                break!
              </p>
            </div>
            <div className="space-y-2">
              ...
              <p>
                ...
                you have what it takes to top the leaderboard. Good luck, and
                have fun!
              </p>
            </div>
          </CardContent>
